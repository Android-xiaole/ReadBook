...
public class DateHelper {
    ...
    public static DateHelper sDateHelper;

    public static DateHelper getInstance() {
        if (sDateHelper == null) {
            sDateHelper = new DateHelper();
        }
        return sDateHelper;
    }
    ...
    public static long getSec(String formatStr) {
        return getSec(formatStr, Constants.DateFormat.YMDHMS);
    }

    public static long getSec(String formatStr, String pattern) {
        if (formatStr == null) {
            return 0;
        }
        SimpleDateFormat format = new SimpleDateFormat(pattern);//如果是小写的hh那转换出来的就是 12小时制的时间  大写的就是24小时制的
        Date d;
        long time = 0;
        try {
    ...
    public static long getSec2(String formatStr) {
        ...
        SimpleDateFormat format = new SimpleDateFormat(Constants.DateFormat.YMDHM);
        Date d;
        long time = 0;
        try {
            d = format.parse(formatStr);
    ...
    public static long getSecDate(String formatStr) {
        ...
        SimpleDateFormat format = new SimpleDateFormat(Constants.DateFormat.YMD);
        Date d;
        long time = 0;
        try {
            d = format.parse(formatStr);
    ...
    public static long getSecTime(String formatStr) {
        ...
        SimpleDateFormat format = new SimpleDateFormat(Constants.DateFormat.HM);
        Date d;
        long time = 0;
        try {
            d = format.parse(formatStr);
...
//        return seconds+"秒/"+minutes + "分钟/"+ hours + "小时/"+days + "天";
    ...
    public static String countTime(String endTime) {
        ...
        SimpleDateFormat format = new SimpleDateFormat(Constants.DateFormat.YMDHMS);
        Date date;
        String yearStr;
        String monthStr;
        String dayStr;
    ...
    public static String getCurrentDate() {
        return getCurrentDate(Constants.DateFormat.YMDHMS);
    }
