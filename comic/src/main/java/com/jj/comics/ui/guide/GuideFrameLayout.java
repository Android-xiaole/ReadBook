...
public class GuideFrameLayout extends FrameLayout implements ViewPager.OnPageChangeListener {
...
//    private int dot_on, dot_off;
    ...
    public GuideFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
...
//        dot_ll.setOrientation(LinearLayout.HORIZONTAL);
        ...
        for (int i = 0; i < layoutIds.length; i++) {
            ...
            args.putInt(Constants.IntentKey.INDEX, i);
            args.putInt(Constants.IntentKey.COUNT, layoutIds.length);
            args.putInt(Constants.IntentKey.LAYOUT_ID, layoutIds[i]);
...
//        setSelectVp(0);
        ...
        viewPager.setAdapter(new GuideFragmentAdapter(((FragmentActivity) mContext).getSupportFragmentManager(), fragments));
