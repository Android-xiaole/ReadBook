package com.jj.comics.widget.bookreadview.bean;

import android.os.Parcel;
import android.os.Parcelable;

import com.jj.base.BaseApplication;
import com.jj.comics.greendao.gen.BookChapterBeanDao;
import com.jj.comics.greendao.gen.CollBookBeanDao;
...
//    private transient CollBookBeanDao myDao;
    ...
    public String getTitle() {
        return StringUtils.convertCC(title, BaseApplication.getApplication());
    }
    ...
    public String getAuthor() {
        return StringUtils.convertCC(author, BaseApplication.getApplication());
    }
    ...
    public String getShortIntro() {
        return StringUtils.convertCC(shortIntro, BaseApplication.getApplication());
    }
    ...
    public String getCover() {
        return StringUtils.convertCC(cover, BaseApplication.getApplication());
    }
    ...
    public String getUpdated() {
        return StringUtils.convertCC(updated, BaseApplication.getApplication());
    }
    ...
    public String getLastChapter() {
        return StringUtils.convertCC(lastChapter, BaseApplication.getApplication());
    }
    ...
    public String getLastRead() {
        return StringUtils.convertCC(lastRead, BaseApplication.getApplication());
    }
    ...
    public void addBookChapters(List<BookChapterBean> beans){
        bookChapterList.addAll(beans);
        for (BookChapterBean bean : bookChapterList){
            bean.setBookId(get_id());
        }
    }
