package com.jj.comics.widget.bubbleview;
...
import static com.jj.comics.widget.bubbleview.BubbleUtils.dp2px;
import static com.jj.comics.widget.bubbleview.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.comic_e8ebf0));
        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color,
                ContextCompat.getColor(context, R.color.comic_31d352));
