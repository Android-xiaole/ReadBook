...
import com.jj.comics.greendao.gen.BookRecordBeanDao;
import com.jj.comics.greendao.gen.CollBookBeanDao;
import com.jj.comics.greendao.gen.DaoSession;
import com.jj.comics.greendao.gen.DownloadTaskBeanDao;
...
import com.jj.comics.widget.bookreadview.bean.ChapterInfoBean;
import com.jj.comics.widget.bookreadview.bean.CollBookBean;
import com.jj.comics.widget.bookreadview.db.DaoDbHelper;
...
public class BookRepository {
     ...
     * @param fileName
     */
    public File saveChapterFile(String folderName, String fileName, InputStream inputStream) throws IOException {
        File file = BookManager.getBookFile(folderName, fileName);
