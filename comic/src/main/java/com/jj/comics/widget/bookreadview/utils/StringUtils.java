...
import static com.jj.comics.widget.bookreadview.utils.ReadSettingManager.SHARED_READ_CONVERT_TYPE;
...
public class StringUtils {
    ...
    public static String getString(@StringRes int id, Object... formatArgs){
        return BaseApplication.getApplication().getResources().getString(id,formatArgs);
    }
