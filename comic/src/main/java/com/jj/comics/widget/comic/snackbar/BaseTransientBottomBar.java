...
import static com.jj.comics.widget.comic.snackbar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR;
...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content,
        ...
        mView = (SnackbarBaseLayout) inflater.inflate(
                R.layout.comic_design_layout_top_snackbar, mTargetParent, false);
