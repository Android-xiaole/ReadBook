...
public class NetWorkUtil {
    ...
    public static boolean isAvailableByPing(String ip) {
        if (ip == null || ip.length() <= 0) {
            ip = BaseApplication.getApplication().getString(R.string.base_default_ip);// default ping ip
        }
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) BaseApplication.getApplication().getSystemService(Context
                            .TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) BaseApplication.getApplication().getSystemService(WIFI_SERVICE);
        //noinspection ConstantConditions
    ...
    @RequiresPermission(allOf = {INTERNET, ACCESS_NETWORK_STATE, ACCESS_WIFI_STATE})
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) BaseApplication.getApplication().getSystemService(WIFI_SERVICE);
        //noinspection ConstantConditions
